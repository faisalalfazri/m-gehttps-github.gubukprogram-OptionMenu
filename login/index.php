					...
					<form class="md-float-material" name="login" id="login" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-xs-10 offset-xs-1 ">
								<button type="submit" id="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20"><?=$LABEL_SIGN_IN;?></button>
							</div>
						</div>
						<!-- <div class="card-footer"> -->
						<div class="col-sm-5 col-xs-12 forgot-phone text-left">
							<a href="../forgot" class="text-right f-w-600"> <?=$LABEL_FORGOT_PASSWORD;?></a>
						</div>
						<div class="col-sm-7 col-xs-12 text-right">
							<span class="text-muted"><?=$LABEL_DONT_HAVE_ACCOUNT;?></span>
							<a href="register" class="f-w-600 p-l-5"><?=$LABEL_SIGN_UP;?></a>
						</div>
